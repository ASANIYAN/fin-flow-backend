...
`;
        ...
        if (error.name === "PrismaClientInitializationError") {
            ...
            return (0, message_1.errorResponse)(res, 500, "Database connection error. Please try again later.", {
                error: {
                    name: error.name,
                    message: error.message,
                    clientVersion: error.clientVersion,
...
const login = async (req, res) => {
    ...
    try {
        ...
        if (err?.name === "PrismaClientInitializationError") {
            return (0, message_1.errorResponse)(res, 500, "Database connection error. Please try again.");
        }
