 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get("/my-loans", authMiddleware_1.authenticateToken, authMiddleware_1.requireEmailVerification, (0, authMiddleware_1.requireRole)(prisma_1.Role.BORROWER), loanController_1.getMyLoans);
/**
 * @swagger
 * /api/loans/{id}/fund:
 *   post:
