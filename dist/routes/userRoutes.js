 ...
 */
router.get("/profile", authMiddleware_1.authenticateToken, authMiddleware_1.requireEmailVerification, getUserProfileHandler);
/**
 * @swagger
 * /api/user/profile:
 *   patch:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.patch("/profile", authMiddleware_1.authenticateToken, authMiddleware_1.requireEmailVerification, updateUserProfileHandler);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.get("/transactions", authMiddleware_1.authenticateToken, authMiddleware_1.requireEmailVerification, getUserTransactionsHandler);
